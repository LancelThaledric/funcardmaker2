<section class="fcm-panel" id="fcm-panel-mpw3-capa">
    <h2>Capacité et Texte d'ambiance</h2>
    <div class="fcm-columns">
        <div class="input-container">
            <div class="input-container">
                <label for="fcm-field-capa1" class="large">Case du haut</label>
            ...
            <div class="input-container">
                <label for="fcm-field-capa2" class="large">Case du milieu</label>
                <div class="planeswalker-capa-container">
                    <div class="planeswalker-capa-cost-container">
            ...
            <div class="input-container">
                <label for="fcm-field-capa3" class="large">Case du bas</label>
                <div class="planeswalker-capa-container">
                    <div class="planeswalker-capa-cost-container">
