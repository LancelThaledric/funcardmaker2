<section class="fcm-panel" id="fcm-panel-oldbasicbackground">
    ...
    <div class="fcm-columns">
        ...
        <div class="fcm-selector has-inner" id="fcm-background-capabox-selector" data-field="fcm-field-background-capabox" data-separator="/">
            <h3 class="has-panel-top">Capabox</h3>
            <div class="fcm-panel-top-toolbar">
                <button class="fcm-toggle-button fcm-toggle-duoselector">
                    <i class="fa fa-adjust fa-fw"></i>
                    &nbsp; Hybride
            ...
            <input type="hidden" class="fcm-selector-field"
                   name="fcm-field-background-capabox"
                   id="fcm-field-background-capabox"
                   value="" />
            <div class="fcm-selector-inner" id="fcm-background-capabox-grid">
                <button class="fcm-selector-button" data-value="w" title="Blanc">
                    <div class="fcm-color-button fcm-color-w"></div>
                </button>
                <button class="fcm-selector-button" data-value="u" title="Bleu">
        ...
        <div class="fcm-selector has-inner" id="fcm-background-capaborder-selector" data-field="fcm-field-background-capaborder" data-separator="/">
            <h3 class="has-panel-top">Bordure capabox</h3>
            <div class="fcm-panel-top-toolbar">
                <button class="fcm-toggle-button fcm-toggle-duoselector">
                    <i class="fa fa-adjust fa-fw"></i>
                    &nbsp; Hybride
            ...
            <input type="hidden" class="fcm-selector-field"
                   name="fcm-field-background-capaborder"
                   id="fcm-field-background-capaborder"
                   value="" />
            <div class="fcm-selector-inner" id="fcm-background-capaborder-grid">
                <button class="fcm-selector-button" data-value="lw" title="Terrain Blanc">
                    <div class="fcm-color-button fcm-color-w fcm-color-land"></div>
                </button>
                <button class="fcm-selector-button" data-value="lu" title="Terrain Bleu">
                ...
                <button class="fcm-selector-clear-button active" title="Bordure capabox auto">
                    <div class="fcm-square-cross"><i class="fa fa-times"></i></div>
                </button>
            </div>
        </div>
