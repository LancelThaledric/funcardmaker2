<section class="fcm-panel" id="fcm-panel-modernbasicbackground">
    ...
    <div class="fcm-columns">
        ...
        <div class="fcm-selector has-inner" id="fcm-background-base-selector" data-field="fcm-field-background-base">
            ...
            <div class="fcm-selector-inner" id="fcm-background-base-grid">
                ...
                <button class="fcm-selector-button" data-value="l" title="Terrain">
                    <div class="fcm-color-button fcm-color-l"></div>
                </button>
            </div>
        </div>
